# AuraFun - Creator Vaults

Aura Fun is a dual-collateral protocol on Celo that enables creators and fans to jointly back creator tokens. By leveraging Farcaster activity to derive an "Aura Score," the protocol dynamically adjusts token pegs and supply caps, ensuring that token value is intrinsically tied to creator reputation and community engagement.
